defmodule ForagerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ForagerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ForagerWeb.Gettext, "errors", msg, opts)
    end
  end
